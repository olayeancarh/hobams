...
from .utils.notifications import PasswordResetNotification
from .mixins import (
    AvatarMixin,
...
class AuthToken(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL,  on_delete=models.CASCADE,related_name='authtoken')
...
class User(VerifyEmailMixin, PermissionsMixin, AbstractBaseUser, AvatarMixin):

...
from user_management import models, views
from user_management.tests.test_throttling import THROTTLE_RATE_PATH
...
REGISTRATION_SERIALIZER_META_MODEL = (
    'user_management.serializers.RegistrationSerializer.Meta.model'
)
